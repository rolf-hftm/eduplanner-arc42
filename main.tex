...
\begin{center}
  ...
  \begin{tabular}{L{4cm} L{9cm}}
    ...
    \rowcolor{tablegrey}
    \textbf{Lizenz} & Apache License 2.0 \\
  \end{tabular}
\end{center}
...
\begin{tabularx}{\textwidth}{C{1.5cm} C{2.2cm} L{3.5cm} X}
  ...
  \rowcolor{tablegrey}
  1.1  & 2026-03-06 & Patrick Hari & Apache 2.0 Lizenz hinzugefügt \\
\end{tabularx}
...
% ── KAPITEL ──────────────────────────────────────────────────
\input{chapter/01_introduction_and_goals}
\newpage
\input{chapter/02_constraints}
\newpage
\input{chapter/03_context_and_scope}
\newpage
\input{chapter/04_solution_strategy}
\newpage
\input{chapter/05_building_block_view}
\newpage
\input{chapter/06_runtime_view}
\newpage
\input{chapter/07_deployment_view}
\newpage
\input{chapter/08_crosscutting_concepts}
\newpage
\input{chapter/09_adrs}
\newpage
\input{chapter/10_quality_requirements}
\newpage
\input{chapter/11_risks_and_technical_debt}
\newpage
\input{chapter/12_glossary}
\newpage
\input{chapter/13_operation_and_deployment_runbook}
\newpage
\input{chapter/14_roadmap_and_evolution}
\newpage

% ── ANHANG & REFERENZEN ───────────────────────────────────────
\appendix
\input{appendix/event_storming}
\newpage
\input{appendix/diagrams_landscape}
\newpage
\input{appendix/openapi}
\newpage
